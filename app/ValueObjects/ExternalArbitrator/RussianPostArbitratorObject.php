...
namespace App\ValueObjects\ExternalArbitrator;
...
class RussianPostArbitratorObject implements Jsonable, Arrayable, Stringable
{
    private $login;
    private $password;
    ...
    {
        $instance = new RussianPostArbitratorObject();
