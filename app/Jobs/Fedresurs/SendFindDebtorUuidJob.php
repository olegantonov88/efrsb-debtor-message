...
class SendFindDebtorUuidJob implements ShouldQueue, ShouldBeUniqueUntilProcessing
{
    ...
    {
        return 'fedresurs-find-debtor-uuid-' . $this->parseJobId;
    }
    ...
    public function handle(FedresursMessageListClient $client): void
    {
        ...
        try {
            $response = $client->findDebtorUuid($parseJob->payload ?? []);
            ...
            Log::error('SendFindDebtorUuidJob failed', [
